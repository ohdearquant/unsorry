# sum-octagonal-running-closed-form
...
- **Difficulty:** 3
- **Decomposition sketch:** Induction with Finset.sum_range_succ; resolve the Nat (3k-2) and (2n-1) subtractions by omega/casework. Verified to build (lake env lean).
