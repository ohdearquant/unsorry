...
| Tracked By | [#942](https://github.com/agenticsnz/unsorry/issues/942) | Phase 1 central-build cost measurement | Gates whether Phase 1 (scoping the central elaboration build) is implemented; the measurement contract is SPEC-049-A §5.6. |
