...
**1272 verified proofs · 964 attributed · 308 historical/unknown · 420 logged terminal runs.**
...
| Proofs with run telemetry | 101 (7.9%) |

## Work Queue

**1438 goals · 1173 archived · 3 blocked · 154 open · 99 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 117 | 61 | 52.1% | 71 | 2m 58s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 803 | 802 | 1 | 87 | 100.0% | 1708 | 190875 |
...
**964 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1272 of 1272 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 334 | 87 | 100.0% | 0 | 1 | 0s | — |
