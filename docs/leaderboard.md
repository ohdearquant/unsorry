...
**762 verified proofs · 455 attributed · 307 historical/unknown · 369 logged terminal runs.**
...
| Run success rate | 13.6% |
| Provider attempts | 412 |
| Failed attempts | 362 |
| Attempt yield | 12.1% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 7m 37s / 32m 4s |
| Verified successes per recorded hour | 0.56 |
| Proofs with run telemetry | 50 (6.6%) |

## Work Queue

**929 goals · 703 archived · 3 blocked · 155 open · 59 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 75 | 19 | 25.3% | 71 | 4m 37s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 299 | 298 | 1 | 36 | 100.0% | 610 | 68475 |
...
**455 explicit solver credits · 307 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 762 of 762 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 94 | 12 | 100.0% | 0 | 1 | 0s | — |
