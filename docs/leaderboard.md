...
**198 verified proofs · 78 attributed · 120 historical/unknown · 254 logged terminal runs.**
...
| Failed terminal runs | 172 |
| Decomposed after failure | 16 |
| Failed without decomposition | 156 |
| Run success rate | 32.3% |
| Provider attempts | 303 |
| Failed attempts | 221 |
| Attempt yield | 27.1% |
| Recorded run time | 49h 3m |
| Median / p90 run time | 6m 13s / 31m 52s |
...
| 5 | [@adam91holt](https://github.com/adam91holt) | 6 | 6 | 0 | 37 | 5.4% | 10 | 1150 |
...
| `codex / unknown` | 14 | 54 | 25.9% | 64 | 2 | 6m 44s | 1.79 |
