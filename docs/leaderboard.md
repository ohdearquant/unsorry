...
**1274 verified proofs · 966 attributed · 308 historical/unknown · 422 logged terminal runs.**
...
| Proofs with run telemetry | 103 (8.1%) |

## Work Queue

**1440 goals · 1173 archived · 3 blocked · 154 open · 101 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 119 | 63 | 52.9% | 71 | 2m 55s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 805 | 804 | 1 | 89 | 100.0% | 1710 | 191125 |
...
**966 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1274 of 1274 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 336 | 89 | 100.0% | 0 | 1 | 0s | — |
