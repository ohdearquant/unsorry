...
**601 verified proofs · 300 attributed · 301 historical/unknown · 559 logged terminal runs.**
...
| Median / p90 run time | 4m 30s / 31m 54s |
| Verified successes per recorded hour | 2.49 |
| Proofs with run telemetry | 237 (39.4%) |

## Work Queue

**785 goals · 258 archived · 3 blocked · 172 open · 343 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 83 | 27 | 32.5% | 71 | 4m 15s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 166 | 165 | 1 | 167 | 100.0% | 388 | 42950 |
...
**300 explicit solver credits · 301 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 601 of 601 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 9 | 9 | 100.0% | 0 | 1 | 0s | — |
