...
**448 verified proofs · 160 attributed · 288 historical/unknown · 448 logged terminal runs.**
...
| Proofs with run telemetry | 129 (28.8%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 302 open · 310 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@chat-bit-01](https://github.com/chat-bit-01) | 227 | 0 | 227 | 0 | — | 508 | 56475 |
...
**160 explicit solver credits · 288 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 448 of 448 proof index files. It is used only where explicit `solver≜` provenance is missing.
