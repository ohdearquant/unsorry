...
**1175 verified proofs · 867 attributed · 308 historical/unknown · 403 logged terminal runs.**
...
| Proofs with run telemetry | 84 (7.1%) |

## Work Queue

**1341 goals · 1093 archived · 3 blocked · 154 open · 82 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 706 | 705 | 1 | 70 | 100.0% | 1607 | 178350 |
...
**867 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1175 of 1175 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 239 | 70 | 100.0% | 0 | 1 | 0s | — |
