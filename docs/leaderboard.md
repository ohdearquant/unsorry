...
**746 verified proofs · 440 attributed · 306 historical/unknown · 356 logged terminal runs.**
...
| Run success rate | 10.4% |
| Provider attempts | 399 |
| Failed attempts | 362 |
| Attempt yield | 9.3% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 8m 3s / 32m 4s |
| Verified successes per recorded hour | 0.41 |
| Proofs with run telemetry | 37 (5.0%) |

## Work Queue

**916 goals · 703 archived · 3 blocked · 158 open · 43 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 286 | 285 | 1 | 23 | 100.0% | 595 | 66650 |
...
**440 explicit solver credits · 306 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 746 of 746 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-decide` | 71 | 23 | 100.0% | 0 | 2 | 0s | — |
...
| `2026-06-19T03:35:07Z` | `gzmod-240-pow-sixteen-sub-pow-twelve` | [@ohdearquant](https://github.com/ohdearquant) | `claude / template-zmod-decide` | `proved` | 1 | 0 | 0s |
