...
**1114 verified proofs · 806 attributed · 308 historical/unknown · 382 logged terminal runs.**
...
| Run success rate | 16.5% |
| Provider attempts | 425 |
| Failed attempts | 362 |
| Attempt yield | 14.8% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 7m 16s / 32m 2s |
| Verified successes per recorded hour | 0.70 |
| Proofs with run telemetry | 63 (5.7%) |

## Work Queue

**1280 goals · 1053 archived · 3 blocked · 154 open · 61 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 68 | 12 | 17.6% | 71 | 5m 13s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 645 | 644 | 1 | 49 | 100.0% | 1544 | 170525 |
...
**806 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1114 of 1114 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 179 | 38 | 100.0% | 0 | 1 | 0s | — |
