...
**436 verified proofs · 156 attributed · 280 historical/unknown · 448 logged terminal runs.**
...
| Proofs with run telemetry | 129 (29.6%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 314 open · 298 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@chat-bit-01](https://github.com/chat-bit-01) | 219 | 0 | 219 | 0 | — | 488 | 54275 |
...
**156 explicit solver credits · 280 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 436 of 436 proof index files. It is used only where explicit `solver≜` provenance is missing.
