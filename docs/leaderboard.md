...
**1326 verified proofs · 1018 attributed · 308 historical/unknown · 434 logged terminal runs.**
...
| Run success rate | 26.5% |
| Provider attempts | 477 |
| Failed attempts | 362 |
| Attempt yield | 24.1% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 39s / 32m 0s |
| Verified successes per recorded hour | 1.28 |
| Proofs with run telemetry | 115 (8.7%) |

## Work Queue

**1492 goals · 1213 archived · 3 blocked · 154 open · 113 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 857 | 856 | 1 | 101 | 100.0% | 1762 | 197625 |
...
**1018 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1326 of 1326 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 388 | 101 | 100.0% | 0 | 1 | 0s | — |
