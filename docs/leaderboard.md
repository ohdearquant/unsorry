...
**741 verified proofs · 435 attributed · 306 historical/unknown · 351 logged terminal runs.**
...
| Proofs with run telemetry | 32 (4.3%) |

## Work Queue

**911 goals · 703 archived · 3 blocked · 158 open · 38 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 281 | 280 | 1 | 18 | 100.0% | 580 | 65025 |
...
**435 explicit solver credits · 306 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 741 of 741 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-decide` | 66 | 18 | 100.0% | 0 | 2 | 0s | — |
