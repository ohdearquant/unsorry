...
**1330 verified proofs · 1022 attributed · 308 historical/unknown · 438 logged terminal runs.**
...
| Run success rate | 27.2% |
| Provider attempts | 481 |
| Failed attempts | 362 |
| Attempt yield | 24.7% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 29s / 32m 0s |
| Verified successes per recorded hour | 1.33 |
| Proofs with run telemetry | 119 (8.9%) |

## Work Queue

**1496 goals · 1213 archived · 3 blocked · 154 open · 117 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 861 | 860 | 1 | 105 | 100.0% | 1766 | 198125 |
...
**1022 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1330 of 1330 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 392 | 105 | 100.0% | 0 | 1 | 0s | — |
