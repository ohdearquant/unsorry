...
**1341 verified proofs · 1033 attributed · 308 historical/unknown · 449 logged terminal runs.**
...
| Provider attempts | 492 |
| Failed attempts | 362 |
| Attempt yield | 26.4% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 3s / 31m 58s |
| Verified successes per recorded hour | 1.45 |
| Proofs with run telemetry | 130 (9.7%) |

## Work Queue

**1507 goals · 1213 archived · 3 blocked · 154 open · 128 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 872 | 871 | 1 | 116 | 100.0% | 1777 | 199500 |
...
**1033 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1341 of 1341 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 403 | 116 | 100.0% | 0 | 1 | 0s | — |
