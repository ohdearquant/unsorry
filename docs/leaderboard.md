...
**1201 verified proofs · 893 attributed · 308 historical/unknown · 429 logged terminal runs.**
...
| Proofs with run telemetry | 110 (9.2%) |

## Work Queue

**1367 goals · 1093 archived · 3 blocked · 154 open · 108 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 732 | 731 | 1 | 96 | 100.0% | 1633 | 181600 |
...
**893 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1201 of 1201 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 265 | 96 | 100.0% | 0 | 1 | 0s | — |
