...
**198 verified proofs · 78 attributed · 120 historical/unknown · 255 logged terminal runs.**
...
| Failed terminal runs | 173 |
| Decomposed after failure | 16 |
| Failed without decomposition | 157 |
| Run success rate | 32.2% |
| Provider attempts | 304 |
| Failed attempts | 222 |
| Attempt yield | 27.0% |
| Recorded run time | 49h 11m |
| Median / p90 run time | 6m 15s / 31m 52s |
