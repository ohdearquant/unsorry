...
**2785 verified proofs · 2477 attributed · 308 historical/unknown · 1269 logged terminal runs.**
...
| Provider attempts | 1355 |
| Failed attempts | 427 |
| Attempt yield | 68.5% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 18m 58s |
| Verified successes per recorded hour | 9.99 |
| Proofs with run telemetry | 928 (33.3%) |

## Work Queue

**2808 goals · 1859 archived · 3 blocked · 11 open · 926 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 966 | 888 | 91.9% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1732 | 1731 | 1 | 794 | 100.0% | 2609 | 0.0 | 304200 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1206.0 | 155075 |
...
**2477 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2785 of 2785 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1867 | 911 | 100.0% | 0 | 3 | 0s | — |
