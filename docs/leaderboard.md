...
**1215 verified proofs · 907 attributed · 308 historical/unknown · 403 logged terminal runs.**
...
| Proofs with run telemetry | 84 (6.9%) |

## Work Queue

**1381 goals · 1133 archived · 3 blocked · 154 open · 82 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 746 | 745 | 1 | 70 | 100.0% | 1647 | 183350 |
...
**907 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1215 of 1215 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 279 | 70 | 100.0% | 0 | 1 | 0s | — |
