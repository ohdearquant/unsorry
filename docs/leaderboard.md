...
**104 verified proofs · 24 attributed · 80 historical/unknown · 30 logged terminal runs.**
...
| Proofs with run telemetry | 22 (21.1%) |
...
**24 explicit solver credits · 80 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 104 of 104 proof index files. It is used only where explicit `solver≜` provenance is missing.
