...
**2774 verified proofs · 2466 attributed · 308 historical/unknown · 1258 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 917 |
| Failed terminal runs | 341 |
| Decomposed after failure | 20 |
| Failed without decomposition | 321 |
| Run success rate | 72.9% |
| Provider attempts | 1344 |
| Failed attempts | 427 |
| Attempt yield | 68.2% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 20m 27s |
| Verified successes per recorded hour | 9.87 |
| Proofs with run telemetry | 917 (33.1%) |

## Work Queue

**2797 goals · 1859 archived · 3 blocked · 11 open · 915 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 955 | 877 | 91.8% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1721 | 1720 | 1 | 783 | 100.0% | 2598 | 0.0 | 302825 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1197.0 | 154175 |
...
**2466 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2774 of 2774 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1854 | 898 | 100.0% | 0 | 3 | 0s | — |
