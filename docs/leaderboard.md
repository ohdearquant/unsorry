...
**1961 verified proofs · 1653 attributed · 308 historical/unknown · 673 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 343 |
| Failed terminal runs | 330 |
| Decomposed after failure | 20 |
| Failed without decomposition | 310 |
| Run success rate | 51.0% |
| Provider attempts | 739 |
| Failed attempts | 396 |
| Attempt yield | 46.4% |
| Recorded run time | 91h 21m |
| Median / p90 run time | 2m 33s / 31m 42s |
| Verified successes per recorded hour | 3.75 |
| Proofs with run telemetry | 343 (17.5%) |

## Work Queue

**1986 goals · 1485 archived · 3 blocked · 13 open · 476 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 370 | 303 | 81.9% | 105 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 978 | 977 | 1 | 208 | 100.0% | 1855 | 0.0 | 209950 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 497 | 250 | 247 | 0 | — | 1324 | 0.0 | 144825 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 328 | 22.3% | 297 | 543.6 | 88835 |
| 4 | [@ruvnet](https://github.com/ruvnet) | 158 | 158 | 0 | 0 | — | 422 | 0.0 | 46150 |
| 5 | [@perttu](https://github.com/perttu) | 106 | 102 | 4 | 78 | 76.9% | 170 | 119.7 | 31620 |
...
**1653 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1961 of 1961 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1113 | 326 | 100.0% | 0 | 3 | 0s | — |
| `claude / template-zmod-decide` | 250 | 0 | — | 0 | 1 | — | — |
