...
**532 verified proofs · 241 attributed · 291 historical/unknown · 513 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 194 |
...
| Proofs with run telemetry | 194 (36.5%) |

## Work Queue

**774 goals · 138 archived · 3 blocked · 230 open · 394 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 107 | 107 | 0 | 107 | 100.0% | 255 | 28175 |
...
**241 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 532 of 532 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 26 | 26 | 100.0% | 0 | 1 | 0s | — |
