...
**1243 verified proofs · 935 attributed · 308 historical/unknown · 431 logged terminal runs.**
...
| Proofs with run telemetry | 112 (9.0%) |

## Work Queue

**1409 goals · 1133 archived · 3 blocked · 154 open · 110 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 774 | 773 | 1 | 98 | 100.0% | 1679 | 187250 |
...
**935 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1243 of 1243 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 305 | 96 | 100.0% | 0 | 1 | 0s | — |
