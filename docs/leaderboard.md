...
**2742 verified proofs · 2434 attributed · 308 historical/unknown · 1226 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 885 |
| Failed terminal runs | 341 |
| Decomposed after failure | 20 |
| Failed without decomposition | 321 |
| Run success rate | 72.2% |
| Provider attempts | 1312 |
| Failed attempts | 427 |
| Attempt yield | 67.5% |
| Recorded run time | 92h 55m |
| Median / p90 run time | 0s / 26m 6s |
| Verified successes per recorded hour | 9.52 |
| Proofs with run telemetry | 885 (32.3%) |

## Work Queue

**2765 goals · 1859 archived · 3 blocked · 11 open · 883 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 923 | 845 | 91.5% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1689 | 1688 | 1 | 751 | 100.0% | 2566 | 0.0 | 298825 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1169.1 | 151385 |
...
**2434 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2742 of 2742 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1824 | 868 | 100.0% | 0 | 3 | 0s | — |
