...
**542 verified proofs · 251 attributed · 291 historical/unknown · 523 logged terminal runs.**
...
| Median / p90 run time | 5m 16s / 31m 55s |
| Verified successes per recorded hour | 2.08 |
| Proofs with run telemetry | 204 (37.6%) |

## Work Queue

**774 goals · 138 archived · 3 blocked · 220 open · 404 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 117 | 117 | 0 | 117 | 100.0% | 277 | 30625 |
...
**251 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 542 of 542 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 35 | 35 | 100.0% | 0 | 1 | 0s | — |
