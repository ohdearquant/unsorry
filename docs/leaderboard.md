...
**1072 verified proofs · 764 attributed · 308 historical/unknown · 380 logged terminal runs.**
...
| Proofs with run telemetry | 61 (5.7%) |

## Work Queue

**1238 goals · 1013 archived · 3 blocked · 154 open · 59 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 73 | 17 | 23.3% | 71 | 4m 38s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 603 | 602 | 1 | 47 | 100.0% | 1436 | 158675 |
...
**764 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1072 of 1072 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 137 | 10 | 100.0% | 0 | 1 | 0s | — |
