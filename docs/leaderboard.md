...
**1333 verified proofs · 1025 attributed · 308 historical/unknown · 441 logged terminal runs.**
...
| Median / p90 run time | 5m 25s / 31m 58s |
| Verified successes per recorded hour | 1.36 |
| Proofs with run telemetry | 122 (9.2%) |

## Work Queue

**1499 goals · 1213 archived · 3 blocked · 154 open · 120 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 864 | 863 | 1 | 108 | 100.0% | 1769 | 198500 |
...
**1025 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1333 of 1333 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 395 | 108 | 100.0% | 0 | 1 | 0s | — |
