...
**159 verified proofs · 38 attributed · 121 historical/unknown · 107 logged terminal runs.**
...
| Provider attempts | 133 |
| Failed attempts | 100 |
| Attempt yield | 24.8% |
| Recorded run time | 16h 52m |
| Median / p90 run time | 4m 53s / 31m 28s |
| Verified successes per recorded hour | 1.96 |
| Proofs with run telemetry | 33 (20.8%) |

## Work Queue

**192 goals · 8 blocked · 57 open · 117 proved · 10 translated.**
...
**38 explicit solver credits · 121 inferred git credits · 0 uncredited proof records.**
