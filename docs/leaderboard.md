...
**676 verified proofs · 371 attributed · 305 historical/unknown · 629 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 310 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 49.3% |
| Provider attempts | 680 |
| Failed attempts | 370 |
| Attempt yield | 45.6% |
| Recorded run time | 96h 32m |
| Median / p90 run time | 3m 55s / 31m 46s |
| Verified successes per recorded hour | 3.21 |
| Proofs with run telemetry | 307 (45.4%) |

## Work Queue

**851 goals · 258 archived · 3 blocked · 163 open · 418 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 132 | 76 | 57.6% | 71 | 2m 38s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 236 | 235 | 1 | 237 | 100.0% | 496 | 55500 |
...
**371 explicit solver credits · 305 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 676 of 676 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 57 | 57 | 100.0% | 0 | 1 | 0s | — |
