...
**1192 verified proofs · 884 attributed · 308 historical/unknown · 420 logged terminal runs.**
...
| Proofs with run telemetry | 101 (8.5%) |

## Work Queue

**1358 goals · 1093 archived · 3 blocked · 154 open · 99 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 723 | 722 | 1 | 87 | 100.0% | 1624 | 180475 |
...
**884 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1192 of 1192 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 256 | 87 | 100.0% | 0 | 1 | 0s | — |
