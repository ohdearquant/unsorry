...
**794 verified proofs · 486 attributed · 308 historical/unknown · 395 logged terminal runs.**
...
| Run success rate | 19.2% |
| Provider attempts | 438 |
| Failed attempts | 362 |
| Attempt yield | 17.3% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 45s / 32m 2s |
| Verified successes per recorded hour | 0.85 |
| Proofs with run telemetry | 76 (9.6%) |

## Work Queue

**960 goals · 703 archived · 3 blocked · 154 open · 91 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 325 | 324 | 1 | 62 | 100.0% | 648 | 72925 |
...
**486 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 794 of 794 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-zmod-decide` | 83 | 30 | 100.0% | 0 | 2 | 0s | — |
