...
**1278 verified proofs · 970 attributed · 308 historical/unknown · 426 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 107 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 25.1% |
| Provider attempts | 469 |
| Failed attempts | 362 |
| Attempt yield | 22.8% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 58s / 32m 0s |
| Verified successes per recorded hour | 1.19 |
| Proofs with run telemetry | 107 (8.4%) |

## Work Queue

**1444 goals · 1173 archived · 3 blocked · 154 open · 105 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 123 | 67 | 54.5% | 71 | 2m 33s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 809 | 808 | 1 | 93 | 100.0% | 1714 | 191625 |
...
**970 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1278 of 1278 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 340 | 93 | 100.0% | 0 | 1 | 0s | — |
