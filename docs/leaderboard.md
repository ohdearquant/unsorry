...
**1147 verified proofs · 839 attributed · 308 historical/unknown · 415 logged terminal runs.**
...
| Proofs with run telemetry | 96 (8.4%) |

## Work Queue

**1313 goals · 1053 archived · 3 blocked · 154 open · 94 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 100 | 44 | 44.0% | 71 | 3m 38s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 678 | 677 | 1 | 82 | 100.0% | 1579 | 174850 |
...
**839 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1147 of 1147 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 211 | 70 | 100.0% | 0 | 1 | 0s | — |
