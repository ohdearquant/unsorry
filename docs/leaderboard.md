...
**769 verified proofs · 461 attributed · 308 historical/unknown · 374 logged terminal runs.**
...
| Run success rate | 14.7% |
| Provider attempts | 417 |
| Failed attempts | 362 |
| Attempt yield | 13.2% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 7m 35s / 32m 2s |
| Verified successes per recorded hour | 0.61 |
| Proofs with run telemetry | 55 (7.1%) |

## Work Queue

**935 goals · 703 archived · 3 blocked · 154 open · 66 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 304 | 303 | 1 | 41 | 100.0% | 615 | 69100 |
...
**461 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 769 of 769 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 99 | 17 | 100.0% | 0 | 1 | 0s | — |
