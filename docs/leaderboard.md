...
**450 verified proofs · 160 attributed · 290 historical/unknown · 448 logged terminal runs.**
...
| Proofs with run telemetry | 129 (28.7%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 300 open · 312 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@chat-bit-01](https://github.com/chat-bit-01) | 229 | 0 | 229 | 0 | — | 513 | 57025 |
...
**160 explicit solver credits · 290 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 450 of 450 proof index files. It is used only where explicit `solver≜` provenance is missing.
