...
**1171 verified proofs · 863 attributed · 308 historical/unknown · 399 logged terminal runs.**
...
| Proofs with run telemetry | 80 (6.8%) |

## Work Queue

**1337 goals · 1093 archived · 3 blocked · 154 open · 78 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 702 | 701 | 1 | 66 | 100.0% | 1603 | 177850 |
...
**863 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1171 of 1171 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 235 | 66 | 100.0% | 0 | 1 | 0s | — |
