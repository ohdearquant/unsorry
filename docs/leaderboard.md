...
**1218 verified proofs · 910 attributed · 308 historical/unknown · 406 logged terminal runs.**
...
| Proofs with run telemetry | 87 (7.1%) |

## Work Queue

**1384 goals · 1133 archived · 3 blocked · 154 open · 85 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 749 | 748 | 1 | 73 | 100.0% | 1650 | 183725 |
...
**910 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1218 of 1218 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 282 | 73 | 100.0% | 0 | 1 | 0s | — |
