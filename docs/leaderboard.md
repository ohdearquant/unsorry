...
**1149 verified proofs · 841 attributed · 308 historical/unknown · 417 logged terminal runs.**
...
| Proofs with run telemetry | 98 (8.5%) |

## Work Queue

**1315 goals · 1053 archived · 3 blocked · 154 open · 96 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 680 | 679 | 1 | 84 | 100.0% | 1581 | 175100 |
...
**841 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1149 of 1149 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 213 | 72 | 100.0% | 0 | 1 | 0s | — |
