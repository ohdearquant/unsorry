...
**218 verified proofs · 81 attributed · 137 historical/unknown · 280 logged terminal runs.**
...
| Failed terminal runs | 195 |
| Decomposed after failure | 16 |
| Failed without decomposition | 179 |
| Run success rate | 30.4% |
| Provider attempts | 329 |
| Failed attempts | 244 |
| Attempt yield | 25.8% |
| Recorded run time | 55h 32m |
| Median / p90 run time | 6m 30s / 31m 54s |
| Verified successes per recorded hour | 1.53 |
| Proofs with run telemetry | 85 (39.0%) |

## Work Queue

**659 goals · 80 archived · 7 blocked · 426 open · 136 proved · 10 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 102 | 55 | 47 | 204 | 28.9% | 177 | 20250 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 76 | 0 | 76 | 0 | — | 162 | 18100 |
| 3 | [@perttu](https://github.com/perttu) | 19 | 19 | 0 | 31 | 74.2% | 41 | 4575 |
| 4 | [@binto](https://github.com/binto) | 9 | 0 | 9 | 0 | — | 19 | 2125 |
| 5 | [@adam91holt](https://github.com/adam91holt) | 6 | 6 | 0 | 44 | 4.5% | 10 | 1150 |
...
**81 explicit solver credits · 137 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 218 of 218 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `codex / unknown` | 14 | 61 | 22.9% | 71 | 2 | 6m 48s | 1.59 |
