...
**1293 verified proofs · 985 attributed · 308 historical/unknown · 401 logged terminal runs.**
...
| Median / p90 run time | 6m 41s / 32m 1s |
| Verified successes per recorded hour | 0.92 |
| Proofs with run telemetry | 82 (6.3%) |

## Work Queue

**1459 goals · 1213 archived · 3 blocked · 154 open · 80 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 98 | 42 | 42.9% | 71 | 3m 42s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 824 | 823 | 1 | 68 | 100.0% | 1729 | 193500 |
...
**985 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1293 of 1293 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 355 | 68 | 100.0% | 0 | 1 | 0s | — |
