...
**1179 verified proofs · 871 attributed · 308 historical/unknown · 407 logged terminal runs.**
...
| Proofs with run telemetry | 88 (7.5%) |

## Work Queue

**1345 goals · 1093 archived · 3 blocked · 154 open · 86 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 710 | 709 | 1 | 74 | 100.0% | 1611 | 178850 |
...
**871 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1179 of 1179 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 243 | 74 | 100.0% | 0 | 1 | 0s | — |
