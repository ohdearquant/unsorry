...
**1280 verified proofs · 972 attributed · 308 historical/unknown · 428 logged terminal runs.**
...
| Run success rate | 25.5% |
| Provider attempts | 471 |
| Failed attempts | 362 |
| Attempt yield | 23.1% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 5m 48s / 32m 0s |
| Verified successes per recorded hour | 1.22 |
| Proofs with run telemetry | 109 (8.5%) |

## Work Queue

**1446 goals · 1173 archived · 3 blocked · 154 open · 107 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 125 | 69 | 55.2% | 71 | 1m 22s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 811 | 810 | 1 | 95 | 100.0% | 1716 | 191875 |
...
**972 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1280 of 1280 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 342 | 95 | 100.0% | 0 | 1 | 0s | — |
