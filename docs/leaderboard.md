...
**1393 verified proofs · 1085 attributed · 308 historical/unknown · 465 logged terminal runs.**
...
| Provider attempts | 508 |
| Failed attempts | 362 |
| Attempt yield | 28.7% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 4m 47s / 31m 58s |
| Verified successes per recorded hour | 1.63 |
| Proofs with run telemetry | 146 (10.5%) |

## Work Queue

**1523 goals · 1213 archived · 2 blocked · 119 open · 180 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 162 | 106 | 65.4% | 71 | 0s |
...
Rank uses credited verified proofs. Explicit `solver≜...` provenance wins; older proof records without solver provenance use git add-author attribution as inferred historical credit. **Dispatch credit** awards half a proof's difficulty to the contributor who opened/landed someone else's proof PR (self-dispatch excluded); it is added to Score.

| Rank | Contributor | Proof credit | Explicit | Inferred | Runs | Run success | Difficulty points | Dispatch (½-diff) | Score |
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 888 | 887 | 1 | 132 | 100.0% | 1793 | 0.0 | 201500 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 268 | 21 | 247 | 0 | — | 637 | 0.0 | 70400 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 118 | 71 | 47 | 265 | 4.9% | 212 | 120.5 | 36200 |
| 4 | [@ruvnet](https://github.com/ruvnet) | 61 | 61 | 0 | 0 | — | 151 | 0.0 | 16625 |
| 5 | [@perttu](https://github.com/perttu) | 38 | 34 | 4 | 13 | 7.7% | 84 | 104.0 | 19750 |
...
**1085 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1393 of 1393 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 419 | 132 | 100.0% | 0 | 1 | 0s | — |
