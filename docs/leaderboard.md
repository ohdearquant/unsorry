...
**1183 verified proofs · 875 attributed · 308 historical/unknown · 411 logged terminal runs.**
...
| Proofs with run telemetry | 92 (7.8%) |

## Work Queue

**1349 goals · 1093 archived · 3 blocked · 154 open · 90 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 714 | 713 | 1 | 78 | 100.0% | 1615 | 179350 |
...
**875 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1183 of 1183 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 247 | 78 | 100.0% | 0 | 1 | 0s | — |
