...
**447 verified proofs · 160 attributed · 287 historical/unknown · 448 logged terminal runs.**
...
| Proofs with run telemetry | 129 (28.9%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 303 open · 309 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@chat-bit-01](https://github.com/chat-bit-01) | 226 | 0 | 226 | 0 | — | 505 | 56150 |
...
**160 explicit solver credits · 287 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 447 of 447 proof index files. It is used only where explicit `solver≜` provenance is missing.
