...
**198 verified proofs · 78 attributed · 120 historical/unknown · 253 logged terminal runs.**
...
| Failed terminal runs | 171 |
| Decomposed after failure | 16 |
| Failed without decomposition | 155 |
| Run success rate | 32.4% |
| Provider attempts | 302 |
| Failed attempts | 220 |
| Attempt yield | 27.2% |
| Recorded run time | 48h 56m |
| Median / p90 run time | 6m 11s / 31m 52s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 99 | 52 | 47 | 185 | 30.3% | 171 | 19575 |
