...
**1965 verified proofs · 1657 attributed · 308 historical/unknown · 676 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 346 |
| Failed terminal runs | 330 |
| Decomposed after failure | 20 |
| Failed without decomposition | 310 |
| Run success rate | 51.2% |
| Provider attempts | 742 |
| Failed attempts | 396 |
| Attempt yield | 46.6% |
| Recorded run time | 91h 21m |
| Median / p90 run time | 2m 15s / 31m 42s |
| Verified successes per recorded hour | 3.79 |
| Proofs with run telemetry | 346 (17.6%) |

## Work Queue

**1990 goals · 1485 archived · 3 blocked · 13 open · 480 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 373 | 306 | 82.0% | 105 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 981 | 980 | 1 | 211 | 100.0% | 1858 | 0.0 | 210325 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 498 | 251 | 247 | 0 | — | 1327 | 0.0 | 145150 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 328 | 22.3% | 297 | 547.2 | 89195 |
...
**1657 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1965 of 1965 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1116 | 329 | 100.0% | 0 | 3 | 0s | — |
| `claude / template-zmod-decide` | 251 | 0 | — | 0 | 1 | — | — |
