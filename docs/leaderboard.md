...
**521 verified proofs · 230 attributed · 291 historical/unknown · 503 logged terminal runs.**
...
| Provider attempts | 553 |
| Failed attempts | 369 |
| Attempt yield | 33.3% |
| Recorded run time | 98h 5m |
| Median / p90 run time | 5m 37s / 31m 56s |
| Verified successes per recorded hour | 1.88 |
| Proofs with run telemetry | 184 (35.3%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 229 open · 383 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 98 | 98 | 0 | 98 | 100.0% | 233 | 25750 |
...
**230 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 521 of 521 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 19 | 19 | 100.0% | 0 | 1 | 0s | — |
