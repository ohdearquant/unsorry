...
**1151 verified proofs · 843 attributed · 308 historical/unknown · 419 logged terminal runs.**
...
| Proofs with run telemetry | 100 (8.7%) |

## Work Queue

**1317 goals · 1053 archived · 3 blocked · 154 open · 98 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 682 | 681 | 1 | 86 | 100.0% | 1583 | 175350 |
...
**843 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1151 of 1151 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 215 | 74 | 100.0% | 0 | 1 | 0s | — |
