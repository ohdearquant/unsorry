...
**691 verified proofs · 386 attributed · 305 historical/unknown · 644 logged terminal runs.**
...
| Proofs with run telemetry | 322 (46.6%) |

## Work Queue

**865 goals · 258 archived · 3 blocked · 162 open · 433 proved · 9 translated.**
...
**386 explicit solver credits · 305 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 691 of 691 proof index files. It is used only where explicit `solver≜` provenance is missing.
