...
**133 verified proofs · 51 attributed · 82 historical/unknown · 140 logged terminal runs.**
...
| Provider attempts | 174 |
| Failed attempts | 128 |
| Attempt yield | 26.4% |
| Recorded run time | 24h 44m |
| Median / p90 run time | 4m 52s / 31m 44s |
