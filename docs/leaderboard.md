...
**2615 verified proofs · 2307 attributed · 308 historical/unknown · 1166 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 826 |
| Failed terminal runs | 340 |
| Decomposed after failure | 20 |
| Failed without decomposition | 320 |
| Run success rate | 70.8% |
| Provider attempts | 1250 |
| Failed attempts | 424 |
| Attempt yield | 66.1% |
| Recorded run time | 92h 47m |
| Median / p90 run time | 0s / 31m 18s |
| Verified successes per recorded hour | 8.90 |
| Proofs with run telemetry | 826 (31.6%) |

## Work Queue

**2638 goals · 1791 archived · 3 blocked · 11 open · 824 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 863 | 786 | 91.1% | 133 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1563 | 1562 | 1 | 692 | 100.0% | 2440 | 0.0 | 283075 |
...
**2307 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2615 of 2615 proof index files. It is used only where explicit `solver≜` provenance is missing.
