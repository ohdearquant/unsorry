...
**557 verified proofs · 265 attributed · 292 historical/unknown · 538 logged terminal runs.**
...
| Run success rate | 40.7% |
| Provider attempts | 590 |
| Failed attempts | 371 |
| Attempt yield | 37.1% |
| Recorded run time | 98h 15m |
| Median / p90 run time | 4m 59s / 31m 54s |
| Verified successes per recorded hour | 2.23 |
| Proofs with run telemetry | 218 (39.1%) |

## Work Queue

**775 goals · 138 archived · 3 blocked · 206 open · 419 proved · 9 translated.**
...
| 2 | 241 | 103 | 42.7% | 158 | 4m 38s |
| 3 | 183 | 78 | 42.6% | 119 | 5m 26s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 131 | 131 | 0 | 132 | 100.0% | 312 | 34475 |
...
**265 explicit solver credits · 292 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 557 of 557 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 41 | 42 | 100.0% | 0 | 1 | 0s | — |
