...
**1297 verified proofs · 989 attributed · 308 historical/unknown · 405 logged terminal runs.**
...
| Provider attempts | 448 |
| Failed attempts | 362 |
| Attempt yield | 19.2% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 38s / 32m 1s |
| Verified successes per recorded hour | 0.96 |
| Proofs with run telemetry | 86 (6.6%) |

## Work Queue

**1463 goals · 1213 archived · 3 blocked · 154 open · 84 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 828 | 827 | 1 | 72 | 100.0% | 1733 | 194000 |
...
**989 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1297 of 1297 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 359 | 72 | 100.0% | 0 | 1 | 0s | — |
