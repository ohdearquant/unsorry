...
**690 verified proofs · 385 attributed · 305 historical/unknown · 643 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 324 |
| Failed terminal runs | 319 |
| Decomposed after failure | 18 |
| Failed without decomposition | 301 |
| Run success rate | 50.4% |
| Provider attempts | 694 |
| Failed attempts | 370 |
| Attempt yield | 46.7% |
| Recorded run time | 96h 32m |
| Median / p90 run time | 3m 50s / 31m 44s |
| Verified successes per recorded hour | 3.36 |
| Proofs with run telemetry | 321 (46.5%) |

## Work Queue

**864 goals · 258 archived · 3 blocked · 162 open · 432 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 250 | 249 | 1 | 251 | 100.0% | 511 | 57350 |
...
**385 explicit solver credits · 305 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 690 of 690 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 70 | 70 | 100.0% | 0 | 1 | 0s | — |
