...
**1069 verified proofs · 761 attributed · 308 historical/unknown · 377 logged terminal runs.**
...
| Proofs with run telemetry | 58 (5.4%) |

## Work Queue

**1235 goals · 1013 archived · 3 blocked · 154 open · 56 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 600 | 599 | 1 | 44 | 100.0% | 1433 | 158300 |
...
**761 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1069 of 1069 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 134 | 7 | 100.0% | 0 | 1 | 0s | — |
