...
**795 verified proofs · 487 attributed · 308 historical/unknown · 396 logged terminal runs.**
...
| Proofs with run telemetry | 77 (9.7%) |

## Work Queue

**961 goals · 703 archived · 3 blocked · 154 open · 92 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 326 | 325 | 1 | 63 | 100.0% | 651 | 73250 |
...
**487 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 795 of 795 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 114 | 32 | 100.0% | 0 | 1 | 0s | — |
| `claude / template-zmod-decide` | 84 | 31 | 100.0% | 0 | 2 | 0s | — |
