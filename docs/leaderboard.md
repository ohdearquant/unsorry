...
**1122 verified proofs · 814 attributed · 308 historical/unknown · 390 logged terminal runs.**
...
| Run success rate | 18.2% |
| Provider attempts | 433 |
| Failed attempts | 362 |
| Attempt yield | 16.4% |
| Recorded run time | 89h 34m |
| Median / p90 run time | 6m 51s / 32m 2s |
| Verified successes per recorded hour | 0.79 |
| Proofs with run telemetry | 71 (6.3%) |

## Work Queue

**1288 goals · 1053 archived · 3 blocked · 154 open · 69 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 76 | 20 | 26.3% | 71 | 4m 27s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 653 | 652 | 1 | 57 | 100.0% | 1552 | 171525 |
...
**814 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1122 of 1122 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 187 | 46 | 100.0% | 0 | 1 | 0s | — |
