...
**1195 verified proofs · 887 attributed · 308 historical/unknown · 423 logged terminal runs.**
...
| Proofs with run telemetry | 104 (8.7%) |

## Work Queue

**1361 goals · 1093 archived · 3 blocked · 154 open · 102 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 726 | 725 | 1 | 90 | 100.0% | 1627 | 180850 |
...
**887 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1195 of 1195 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 259 | 90 | 100.0% | 0 | 1 | 0s | — |
