...
**1204 verified proofs · 896 attributed · 308 historical/unknown · 432 logged terminal runs.**
...
| Proofs with run telemetry | 113 (9.4%) |

## Work Queue

**1370 goals · 1093 archived · 3 blocked · 154 open · 111 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 735 | 734 | 1 | 99 | 100.0% | 1636 | 181975 |
...
**896 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1204 of 1204 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 268 | 99 | 100.0% | 0 | 1 | 0s | — |
