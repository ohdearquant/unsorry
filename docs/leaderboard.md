...
**1226 verified proofs · 918 attributed · 308 historical/unknown · 414 logged terminal runs.**
...
| Proofs with run telemetry | 95 (7.8%) |

## Work Queue

**1392 goals · 1133 archived · 3 blocked · 154 open · 93 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 757 | 756 | 1 | 81 | 100.0% | 1658 | 184725 |
...
**918 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1226 of 1226 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 290 | 81 | 100.0% | 0 | 1 | 0s | — |
