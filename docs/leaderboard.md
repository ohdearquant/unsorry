...
**2397 verified proofs · 2089 attributed · 308 historical/unknown · 1046 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 710 |
| Failed terminal runs | 336 |
| Decomposed after failure | 20 |
| Failed without decomposition | 316 |
| Run success rate | 67.9% |
| Provider attempts | 1124 |
| Failed attempts | 414 |
| Attempt yield | 63.2% |
| Recorded run time | 92h 26m |
| Median / p90 run time | 0s / 31m 21s |
| Verified successes per recorded hour | 7.68 |
| Proofs with run telemetry | 710 (29.6%) |

## Work Queue

**2420 goals · 1655 archived · 3 blocked · 11 open · 742 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 743 | 670 | 90.2% | 123 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1345 | 1344 | 1 | 575 | 100.0% | 2222 | 0.0 | 255825 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 564 | 317 | 247 | 0 | — | 1525 | 0.0 | 166600 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 330 | 22.1% | 297 | 898.2 | 124295 |
| 4 | [@ruvnet](https://github.com/ruvnet) | 160 | 160 | 0 | 0 | — | 429 | 0.0 | 46900 |
| 5 | [@perttu](https://github.com/perttu) | 106 | 102 | 4 | 82 | 73.2% | 170 | 137.7 | 33420 |
...
**2089 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2397 of 2397 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1480 | 693 | 100.0% | 0 | 3 | 0s | — |
