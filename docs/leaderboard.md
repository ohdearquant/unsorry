...
**1153 verified proofs · 845 attributed · 308 historical/unknown · 421 logged terminal runs.**
...
| Proofs with run telemetry | 102 (8.8%) |

## Work Queue

**1319 goals · 1053 archived · 3 blocked · 154 open · 100 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 684 | 683 | 1 | 88 | 100.0% | 1585 | 175600 |
...
**845 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1153 of 1153 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 217 | 76 | 100.0% | 0 | 1 | 0s | — |
