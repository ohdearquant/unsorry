...
**1260 verified proofs · 952 attributed · 308 historical/unknown · 408 logged terminal runs.**
...
| Proofs with run telemetry | 89 (7.1%) |

## Work Queue

**1426 goals · 1173 archived · 3 blocked · 154 open · 87 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 791 | 790 | 1 | 75 | 100.0% | 1696 | 189375 |
...
**952 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1260 of 1260 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 322 | 75 | 100.0% | 0 | 1 | 0s | — |
