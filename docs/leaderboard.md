...
**1234 verified proofs · 926 attributed · 308 historical/unknown · 422 logged terminal runs.**
...
| Proofs with run telemetry | 103 (8.3%) |

## Work Queue

**1400 goals · 1133 archived · 3 blocked · 154 open · 101 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 765 | 764 | 1 | 89 | 100.0% | 1666 | 185725 |
...
**926 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1234 of 1234 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 298 | 89 | 100.0% | 0 | 1 | 0s | — |
