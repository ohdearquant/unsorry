...
**1339 verified proofs · 1031 attributed · 308 historical/unknown · 447 logged terminal runs.**
...
| Median / p90 run time | 5m 16s / 31m 58s |
| Verified successes per recorded hour | 1.43 |
| Proofs with run telemetry | 128 (9.6%) |

## Work Queue

**1505 goals · 1213 archived · 3 blocked · 154 open · 126 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 870 | 869 | 1 | 114 | 100.0% | 1775 | 199250 |
...
**1031 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1339 of 1339 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `claude / template-ring-cofactor` | 401 | 114 | 100.0% | 0 | 1 | 0s | — |
