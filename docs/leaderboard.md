...
**198 verified proofs · 78 attributed · 120 historical/unknown · 249 logged terminal runs.**
...
| Failed terminal runs | 167 |
| Decomposed after failure | 16 |
| Failed without decomposition | 151 |
| Run success rate | 32.9% |
| Provider attempts | 298 |
| Failed attempts | 216 |
| Attempt yield | 27.5% |
| Recorded run time | 47h 40m |
| Median / p90 run time | 5m 51s / 31m 52s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 99 | 52 | 47 | 182 | 30.8% | 171 | 19575 |
...
| `openai / leanstral-2603` | 11 | 115 | 11.3% | 106 | 1 | 4m 54s | 0.59 |
