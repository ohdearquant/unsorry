...
**497 verified proofs · 206 attributed · 291 historical/unknown · 486 logged terminal runs.**
...
| Proofs with run telemetry | 167 (33.6%) |

## Work Queue

**762 goals · 138 archived · 3 blocked · 253 open · 359 proved · 9 translated.**
...
**206 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 497 of 497 proof index files. It is used only where explicit `solver≜` provenance is missing.
