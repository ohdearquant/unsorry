...
**1239 verified proofs · 931 attributed · 308 historical/unknown · 427 logged terminal runs.**
...
| Proofs with run telemetry | 108 (8.7%) |

## Work Queue

**1405 goals · 1133 archived · 3 blocked · 154 open · 106 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 770 | 769 | 1 | 94 | 100.0% | 1671 | 186350 |
...
**931 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1239 of 1239 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 303 | 94 | 100.0% | 0 | 1 | 0s | — |
