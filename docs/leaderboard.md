...
**216 verified proofs · 81 attributed · 135 historical/unknown · 278 logged terminal runs.**
...
| Proofs with run telemetry | 85 (39.4%) |

## Work Queue

**659 goals · 80 archived · 7 blocked · 428 open · 134 proved · 10 translated.**
...
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 74 | 0 | 74 | 0 | — | 158 | 17650 |
...
**81 explicit solver credits · 135 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 216 of 216 proof index files. It is used only where explicit `solver≜` provenance is missing.
