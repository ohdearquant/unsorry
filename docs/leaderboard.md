...
**541 verified proofs · 250 attributed · 291 historical/unknown · 522 logged terminal runs.**
...
| Provider attempts | 574 |
| Failed attempts | 371 |
| Attempt yield | 35.4% |
| Recorded run time | 98h 15m |
| Median / p90 run time | 5m 17s / 31m 55s |
| Verified successes per recorded hour | 2.07 |
| Proofs with run telemetry | 203 (37.5%) |

## Work Queue

**774 goals · 138 archived · 3 blocked · 221 open · 403 proved · 9 translated.**
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 116 | 116 | 0 | 116 | 100.0% | 275 | 30400 |
...
**250 explicit solver credits · 291 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 541 of 541 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-sum-induction` | 34 | 34 | 100.0% | 0 | 1 | 0s | — |
