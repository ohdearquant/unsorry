...
**2803 verified proofs · 2495 attributed · 308 historical/unknown · 1287 logged terminal runs.**
...
| Verified successes per recorded hour | 10.18 |
| Proofs with run telemetry | 946 (33.8%) |

## Work Queue

**2826 goals · 1859 archived · 3 blocked · 11 open · 944 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 984 | 906 | 92.1% | 136 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 1750 | 1749 | 1 | 812 | 100.0% | 2627 | 0.0 | 306450 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 565 | 318 | 247 | 0 | — | 1528 | 0.0 | 166925 |
| 3 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 331 | 22.1% | 297 | 1217.7 | 156245 |
...
**2495 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 2803 of 2803 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 1885 | 929 | 100.0% | 0 | 3 | 0s | — |
