...
**1264 verified proofs · 956 attributed · 308 historical/unknown · 412 logged terminal runs.**
...
| Proofs with run telemetry | 93 (7.4%) |

## Work Queue

**1430 goals · 1173 archived · 3 blocked · 154 open · 91 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------:|
| 1 | [@ohdearquant](https://github.com/ohdearquant) | 795 | 794 | 1 | 79 | 100.0% | 1700 | 189875 |
...
**956 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 1264 of 1264 proof index files. It is used only where explicit `solver≜` provenance is missing.
...
| `claude / template-ring-cofactor` | 326 | 79 | 100.0% | 0 | 1 | 0s | — |
