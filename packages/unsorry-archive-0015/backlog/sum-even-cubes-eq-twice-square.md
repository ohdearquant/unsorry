# sum-even-cubes-eq-twice-square

The sum of the first n even cubes equals 2n^2(n+1)^2.

- **Source:** #400 Identity Engine (ADR-043) — figurate-number family; promoted from candidate backlog (#610).
- **Reference:** The sum of the first n even cubes equals 2n^2(n+1)^2. Not a named mathlib lemma in this form.
